        ...
        //calculate top up earnings and
          ...
          foreach($plans as $plan){
              ...
              if($settings->trade_mode=='on'){
                ...
                if($plan->inv_duration=="24 Hrs"){
                  $condition=$plan->activated_at->diffInDays() < 1 && $user->trade_mode=="on";
                  $condition2=$plan->activated_at->diffInDays() >= 1;
                }elseif($plan->inv_duration=="One week"){
