					...
					<div class="row profile">
                        ...
                        <div class="col-lg-9 p-2">
                            <div class="card p-5 shadow-lg bg-<?php echo e($bg); ?>">
                                <h5> <span class="fa fa-user"></span> &nbsp; <?php echo e(Auth::user()->name); ?> <?php echo e(Auth::user()->l_name); ?></h5>
                                <h5> <span class="fa fa-location-arrow"></span> &nbsp; 
                                <?php if(Auth::user()->country ===NULL): ?>
                                    Country Not Set! Please Update info.
                                    <?php else: ?>
                               ...
                               <?php endif; ?>
                                ...
                                <!-- <h5> 
                                    <?php if(Auth::user()->account_verify ===NULL): ?>
                                <span class="text-danger fa fa-check-circle"></span> &nbsp;Account Not Verified
                                    <?php elseif(Auth::user()->account_verify ===Verified): ?>
                                     <span class="text-success fa fa-check-circle"></span> &nbsp;Account Verified
                                    <?php else: ?>
                                    <span class="text-warning fa fa-exclamation-circle"></span> &nbsp;Account Under review
                               <?php endif; ?>
                                </h5> -->
                               
                                <form action="javascript:void(0)" method="post" id="styleform" class="form-inline">
                                    <div class="form-group">
                                        <h5 class="text-<?php echo e($text); ?>">Dark Mode:</h5> &nbsp; &nbsp;
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body bg-<?php echo e($bg); ?>">
                                            ...
                                            <input type="text" name="firstname" value="<?php echo e($userinfo->name); ?>" class="form-control bg-<?php echo e($bg); ?> text-<?php echo e($text); ?>"> <br>
                                                ...
                                                <input type="text" name="country"  class="form-control bg-<?php echo e($bg); ?> text-<?php echo e($text); ?>" value="<?php echo e($userinfo->country); ?>">
                                                <!-- <select class="form_control bg-<?php echo e($bg); ?> text-<?php echo e($text); ?>"" name="country" id="country" required>
                                                <?php if($userinfo->country === NULL): ?>{
                                    <option selected disabled value="">Select Country</option>
                                                }
                                             <?php else: ?>{
                                                <option value="<?php echo e($userinfo->country); ?>"><?php echo e($userinfo->country); ?></option>
                                             }   
                                             <?php endif; ?>
                                ...
                                <br>
                                                ...
                                                <textarea class="form-control bg-<?php echo e($bg); ?> text-<?php echo e($text); ?>" placeholder="Full Address" name="address" row="3" value="<?php echo e($userinfo->adress); ?>"><?php echo e($userinfo->adress); ?></textarea><br/>
