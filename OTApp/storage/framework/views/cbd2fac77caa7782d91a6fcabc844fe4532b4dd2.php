		...
		<div class="main-panel">
			<div class="content bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> ">
				<div class="page-inner">
					...
					<div class="row mb-5">
						<div class="col">
							<form class="form-inline m-2" method="post" action="<?php echo e(action('Admin\HomeController@searchDp')); ?>">
								<a class="btn btn-<?php echo e($text); ?>  m-2" href="<?php echo e(url('admin/dashboard/mdeposits')); ?>">Show all</a>
								<input style="" placeholder="Search by user ID, Status, Payment mode, Amount" class="bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?> shadow-sm form-control" type="text" name="query" required>
