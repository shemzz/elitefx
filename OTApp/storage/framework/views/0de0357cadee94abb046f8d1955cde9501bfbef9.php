						...
						<div class="col card p-3 bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
							<nav>
								<div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
								  ...
								  <a class="nav-item nav-link  pt-3" id="nav-contact-tab" data-toggle="tab" href="#3" role="tab" aria-controls="nav-contact" aria-selected="false">Bot Settings</a>
							...
							<div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
								...
								<div class="tab-pane fade p-3 bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>" id="3" role="tabpanel" aria-labelledby="nav-contact-tab">
									<?php echo $__env->make('admin.includes.botsettings', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
								</div>
