  ...
  <header id="header">
    <div class="container-fluid">
      <div id="logo" class="pull-left mt-0">
        ...
        <a href="#intro"><img src="<?php echo e(asset('images/'.$settings->logo)); ?>" alt="<?php echo e($settings->site_name); ?>" title="" class="mt-0 logo" /></a>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-newsletter">
            ...
            <p>Tamen quem nulla quae legam multos aute sint culpa legam noster magna veniam enim veniam
               ...
               caramase seza.</p>
            <form action="" method="post" class="auth-user">
