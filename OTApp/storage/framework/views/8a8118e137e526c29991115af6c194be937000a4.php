        ...
        <div class="main-panel">
			<div class="content bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
				<div class="page-inner">
					...
					<div class="row mb-5">
						<div class="col">
							<form class="form-inline" role="form" method="post" action="<?php echo e(action('Admin\HomeController@searchWt')); ?>">
								<a class="btn btn-<?php echo e($text); ?> m-2" href="<?php echo e(url('admin/dashboard/mwithdrawals')); ?>">Show all</a>
								<input placeholder="Search by user ID, Status, Payment mode, Amount" class="form-control shadow-sm bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" type="text" name="wtquery" required>
								<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<input type="submit"  class="m-2 btn btn-<?php echo e($text); ?>" value="Search">
							</form>
						</div>
					</div>
