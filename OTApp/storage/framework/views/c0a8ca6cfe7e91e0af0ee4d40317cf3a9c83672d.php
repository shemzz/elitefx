			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header bg-dark">
						...
						<h4 class="modal-title">Subscription Payment</h4>
		...
		<!-- Submit MT4 MODAL modal -->
			<div id="submitmt4modal" class="modal fade" role="dialog">
			  <div class="modal-dialog">
			    ...
			    <div class="modal-content">
					<div class="modal-header bg-dark">
						<h4 class="modal-title">Submit your MT4 Login Details</h4>
						<button type="button" class="close text-white" data-dismiss="modal">&times;</button>
			      </div>
			     	<div class="modal-body bg-dark">
              			<form style="padding:3px;" role="form" method="post" action="<?php echo e(action('Controller@savemt4details')); ?>">
			  				<label>MT4 ID*: </label><br/>	
							<input class="form-control"  type="text" name="userid" required><br/>
							<label>MT4 Password*:</label><br/>	
							<input style="padding:5px;" class="form-control"  type="text" name="pswrd" required><br/>
							<label>Account Type:</label><br/>	
							<input  class="form-control" Placeholder="E.g. Standard" type="text" name="acntype" required><br/>
							<label>Currency*:</label><br/>	
							<input  class="form-control" Placeholder="E.g. USD" type="text" name="currency" required><br/>
							<label>Leverage*:</label><br/>	
							<input  class="form-control" Placeholder="E.g. 1:500"  type="text" name="leverage" required><br/>
							<label>Server*:</label><br/>	
							<input  class="form-control" Placeholder="E.g. HantecGlobal-live"  type="text" name="server" required><br/>
