            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						...
						<li class="">
							<a href="#"><i class="fa fa-cog nav_icon"></i>Manage Packages <span class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li>
		...
		<div class="sticky-header header-section ">
			...
			<div class="header-right">
				<div class="profile_details" style="padding:8px; margin-top:15px;">	
					<?php if(Auth::user()->type =='0'): ?>
					<a href="<?php echo e(url('trade/exchange')); ?>" class="btn btn-danger text-white">Live Trading</a> &nbsp;
					<?php endif; ?>
