...
<head>
    ...
    <link rel="icon" href="<?php echo e($settings->site_address); ?>/cloud/app/images/<?php echo e($settings->favicon); ?>" type="image/png"/>
      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox"  >
          ...
          <div class="carousel-item active">
            <div class="carousel-background"><img src="<?php echo e($settings->site_address); ?>/cloud/app/images/<?php echo e($content->getImage('57VnOE','img_path')); ?>" alt=""></div>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo e($settings->site_address); ?>/cloud/app/images/<?php echo e($content->getImage('dC6ZaA','img_path')); ?>" alt="" ></div>
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo e($settings->site_address); ?>/cloud/app/images/<?php echo e($content->getImage('9kHash','img_path')); ?>" alt="">
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo e($settings->site_address); ?>/cloud/app/images/<?php echo e($content->getImage('CcW52g','img_path')); ?>" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo e($settings->site_address); ?>/cloud/app/images/<?php echo e($content->getImage('96i7xH','img_path')); ?>" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <div class="col-lg-8">
            ...
            <div class="owl-carousel testimonials-carousel wow fadeInUp">
              <?php $__currentLoopData = $test; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimony): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <img src="<?php echo e($settings->site_address); ?>/cloud/app/images/<?php echo e($testimony->picture); ?>" class="testimonial-img" alt="">
