									...
									<tbody> 
										...
										<tr> 
											...
											<a href="#" class="btn btn-{{$text}} btn-sm m-1" data-toggle="modal" data-target="#popModal{{$deposit->id}}" title="View payment proof">
												...
												@else
												<a class="btn btn-primary btn-sm" href="{{ url('admin/dashboard/pdeposit') }}/{{$deposit->id}}">Approve</a>
												@endif
												<a href="{{ url('admin/dashboard/manageuser') }}/{{$deposit->user_id}}" class="btn btn-info btn-sm">view user</a>
