					...
					<div class="row profile">
                        ...
                        <div class="col-lg-9 p-2">
                            <div class="card p-5 shadow-lg bg-{{$bg}}">
                                <h5> <span class="fa fa-user"></span> &nbsp; {{ Auth::user()->name }} {{ Auth::user()->l_name }}</h5>
                               ...
                               @endif
                                ...
                                <!-- <h5> 
                                    @if(Auth::user()->account_verify ===NULL)
                               ...
                               @endif
                                ...
                                <form action="javascript:void(0)" method="post" id="styleform" class="form-inline">
                                    <div class="form-group">
                                        <h5 class="text-{{$text}}">Dark Mode:</h5> &nbsp; &nbsp;
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body bg-{{$bg}}">
                                            ...
                                            <input type="text" name="firstname" value="{{$userinfo->name}}" class="form-control bg-{{$bg}} text-{{$text}}"> <br>
                                                ...
                                                <input type="text" name="country"  class="form-control bg-{{$bg}} text-{{$text}}" value="{{$userinfo->country}}">
                                                <!-- <select class="form_control bg-{{$bg}} text-{{$text}}"" name="country" id="country" required>
