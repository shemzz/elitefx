...
Route::get('about-us', 'UsersController@about')->name('about');
Route::get('contact', 'UsersController@contact')->name('contact');
Route::get('faq', 'UsersController@faq')->name('faq');
Route::get('how-it-works', 'UsersController@how');
Route::get('cryptocurrency', 'UsersController@crypto');
Route::get('indices', 'UsersController@indices');
Route::get('forex', 'UsersController@forex');
Route::get('shares', 'UsersController@shares');
Route::get('options', 'UsersController@options');
Route::get('policy', 'UsersController@policy');
...
Route::prefix('elite-admin')->group(function () {
...
Route::group(['prefix' => 'admin',  'middleware' => 'isadmin'], function()
{
	...
	Route::get('dashboard/manageuser/{id}', ['uses' => 'Admin\HomeController@manageuser'])->name('manageuser');
...
Auth::routes();
    ...
    Route::get('activate/{session}', 'UsersController@activate_account');
...
// 	Route::post('dashboard/addwdmethod', 'SomeController@addwdmethod');
	...
	//activate and deactivate `ELitex
